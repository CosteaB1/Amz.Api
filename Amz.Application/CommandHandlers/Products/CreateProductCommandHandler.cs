...
{
    public class CreateProductCommandHandler : IRequestHandler<CreateProductCommand, ProductDto> // to change to public sealed record
    {
        ...
        public async Task<ProductDto> Handle(CreateProductCommand request, CancellationToken cancellationToken)
        {
            ...
            var product = Product.Create(nameResult.Value, request.Description, request.CategoryId, request.SubCategoryId, request.OtherDetails, request.SupplierId, request.Quantity);
